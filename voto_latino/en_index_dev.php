...
<body ng-init="seleccionada = menu[0];" ng-controller="defaultCtrl">
	<div class="content">
		<div class="header">			
			...
			<div class="menu_superior">
				<div class="navegue web">Navegue aquí por la visualización</div>
				<ul>
		...
		<div class="menu">			
			...
			<div id="descripcion" class="descripcion" ng-class="getOptClass();">
				Total de hispanos mayores de 18 años de edad que son ciudadanos y por lo tanto pueden votar
			</div>
		</div>		
		...
		<div class="acerca">
			...
			<p>
				The questions that guide this project are: What would happen in 2013 if no Hispanics voted? Which party would be affected by this? Who would win: the Democrats or the Republicans? And if all hispanics over 18 years of age voted?
			</p>
			<p>
				To answer these questions it was necessary to explore the relationship between voting results and size of the Hispanic population, taking into account the presence of other electoral, political, demographic and sociodemographic factors known to influence voting decisions. These were obtained from several sources and for a series of years.
			</p>
			<p>
				The results for 2014 were taken from the predictions made by the <a href="http://www.washingtonpost.com/wp-dre/politics/election-lab-2014?hpid=z1" target="_blank">Washington Post</a> in june and updated as the election approaches. 
			</p>
			<p>
				The analysis was made using two types of regression models: linear and logistic, with simulations done using Clarify. It's important to note that like every predictive model, there will always be a certain degree of uncertainty, which you can read more about in this <a href="https://www.dropbox.com/s/jpllmo48bnwuid2/Metodolog%C3%ADa%20%28i%29.pdf" target="_blank">link</a>
			</p>
		</div>
		<div class="nota">
			<div class="titulo_nota">
				<div>Methodological note: </div>
				<p class="linea"></p>
			</div>
			<div class="parrafo">
				<p>The data used was taken from the following sources: data related to the House of Representatives election results (2006 a 2012) fwas taken from the Federal Election Comission (hipervínculo a http://www.fec.gov/pubrec/electionresults.shtml)); the predictions for the 2014 election results were taken from the Election Lab of the <a href="http://www.washingtonpost.com/wp-dre/politics/election-lab-2014?hpid=z1" target="_blank">Washington Post</a> the predictions regarding what would happen without Hispanics and if all Hispanics over 18 years of age voted in 2014 where constructed based on the predictions made by the Washington Post and simulations made using the program <a href="hipervínculo a:http://www.gvpt.umd.edu/uslaner/clarify.pdf" target="_blank">Clarify</a> the data regarding representatives of hispanic origin was constructed based on the member list of the House of Representatives; coin-toss district data was obtained from the <a href="http://www.washingtonpost.com/wp-dre/politics/election-lab-2014?hpid=z1" target="_blank">Washington Post predictions</a>, using districts assigned a winning probability between 50 and 74% ; the variable that identifies states belonging to the "Bible belt" was constructed using several sources that mention the states comonly placed under this category; the sociodemographic and demographic data was obtained from the <a href="http://factfinder2.census.gov/faces/nav/jsf/pages/index.xhtml" target="_blank">American Community Survey</a>, which includes census data already calculated by congressional district.
				</p>
				<p>To make prediction in the case that no Hispanics voted and in the case that all Hispanics over 18 years old voted a series of regression analysis were used. The models used where: linear regression (OLS), logistic regression (Logit y Probit) and simulations of these models using <a href="http://www.gvpt.umd.edu/uslaner/clarify.pdf" target="_blank">Clarify</a>.
				<p>For more details regarding the process of investigation regarding this project read the following <a href="https://www.dropbox.com/s/cz504m8ounlvnf4/Metodolog%C3%ADa.pdf" target="_blank">document</a>.
			</div>			
		</div>
		<div class="footer">			
