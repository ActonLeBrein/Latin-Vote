...
<body ng-init="seleccionada = menu[0];" ng-controller="defaultCtrl">
	<div class="content">
		...
		<div class="verInstrucciones" ng-click="instrucciones = true">?</div>
		<svg  id="univision">
		  	<g id="principal">
		...
		<div class="info_acerca" ng-click="acerca = true">!</div>		
		...
		<div class="acerca" ng-show="acerca">
			<div class="titulo_nota">
				<div class="cerrar" ng-click="acerca = false">x</div>
				<div>Acerca de este proyecto:</div>
				<p class="linea"></p>
			</div>
			...
			<p>Se toma como partido ganador de cada distrito al determinado por el  <a href="http://www.washingtonpost.com/wp-dre/politics/election-lab-2014?hpid=z1" target="_blank">Washington Post</a> en sus predicciones realizadas en junio y actualizadas mientras se acerca la elección.</p>
