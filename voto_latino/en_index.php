...
<head>
	...
	<script>
		...
		$.each( json , function (index,value){           
			select_values.push({"value":value.cd, "label":value.state+", District "+value.district});		
		});
	...
	<div class="content">
		<div class="header">
			...
			<div class="menu_superior">			
				<div class="navegue">
					MOVE THROUGH THE INFOGRAPHIC HERE					
				</div>	
				<ul>
			...
			<!--div class="version">ESP</div-->
		</div>
		<!--div class="portada" ng-show="seleccionada == ''">				
			<h1>THE LATIN VOTE</h1>
			<h2>Shifting the Electoral Balance</h2>				
			<div class="balazo">
				Will the Hispanic population be key in the upcoming mid-term elections? What if not one Latino voted in the 2014 election? And what if every Hispanic over 18 years of age voted (including those that aren’t citizens)? Explore this infographic to dimension the Latino’s political force in the United States.
			</div>
		...
		<div class="contenido">
			<div class="modal" ng-show="modal">
				<div id="contenedor_instrucciones" ng-show="instrucciones">
					...
					<p>To explore the following infographic choose the section and, if there's additional options, choose one as well. Once you're looking at the map you can find the state and congressional district that interests you, either by using the search bar or by clicking the state and then the square that represents the district of choice. To see additional information about the district double-click on the square that represents it.</p>
				</div>
				<div class="acerca" ng-show="acerca">
					...
					<p>The questions that guide this project are: What would happen in 2013 if no Hispanics voted? Which party would be affected by this? Who would win: the Democrats or the Republicans? And if all hispanics over 18 years of age voted?</p>
					<p>To answer these questions it was necessary to explore the relationship between voting results and size of the Hispanic population, taking into account the presence of other electoral, political, demographic and sociodemographic factors known to influence voting decisions. These were obtained from several sources and for a series of years.</p>
					<p>The results for 2014 were taken from the predictions made by John Sides, Associate Professor of Political Science at George Washington University, for the Election Lab in the <a href="http://www.washingtonpost.com/wp-dre/politics/election-lab-2014?hpid=z1" target="_blank">Washington Post</a> in june and updated as the election approaches. </p>
					<p>The analysis was made using two types of regression models: linear and logistic, with simulations done using Clarify. It's important to note that like every predictive model, there will always be a certain degree of uncertainty, which you can read more about in this <a href="https://www.dropbox.com/s/jpllmo48bnwuid2/Metodolog%C3%ADa%20%28i%29.pdf?dl=0" target="_blank">link</a>.</p>
				</div>
			</div>
			<div class="superior">
				...
				<div class="menu">			
					...
					<div id="descripcion" class="descripcion" ng-class="getOptClass();">
						Hispanic population over 18 years of age and with citizenship as a percentage of the total population over 18 years of age with US citizenship
		            </div>
				</div>		
			</div>			
			...
			<p class="example_serach">(e.g. California)</p>
			<div class="infoExtra">								
	  			...
	  			<!--div class="ref">
	  			  	<div ng-click="seleccionada='';" class="regresar">Back to cover</div>
	  			</div-->
			</div>
			...
			<div id="texto">				
                ...
                <p>The next five high concentrations of Hispanic voters are all in Texas in five congressional districts which average some 70% of voters. </p> 
                <p>TX34 was created after the 2010 census and is next to the Mexico border. It includes parts of Brownsville and Corpus Christie and Filemon Vela Jr. is the current representative. Vela is the son of longtime federal judge, Filemon Bartolome Vela Sr. and Blanca Sanchez, Brownsville’s first female mayor.</p> 
                <p>TX15, in the deep south of Texas, is 80% populated by Hispanics and Ruben Hinojosa, a Democrat elected in 1996 and leader of the Hispanic Caucus, is its current representative. Since the creation of TX15 in 1903, a democrat has always represented the district. </p> 
                <p>78% of TX16 is Hispanic, too. Beto O’Rourke currently represents the district, and though his name may lead you to think otherwise, O’Rourke is not Hispanic but a fourth generation native of El Paso. O’Rourke is one of seven Texas Democratic representatives who are not Hispanics. He even tried to gain membership to the Hispanic Caucus but was denied do to a lack of Hispanic heritage. The district was been previously represented by Hispanic, Silvestre Reyes (1997-2013), among others. </p> 
                <p>TX20, where most Hispanics are of Mexican descent, spans San Antonio to Bexar. The district has also been consistently Democratic. Since 1956, all Democratic presidential candidates have won here, and three representatives have been Hispanics too: Henry B. Gonzalez (who occupied the seat for 38 years), his son Charlie Gonzalez, and the current representative, Joaquin Castro.</p> 
                <p>Lastly, TX28 starts south of San Antonio and also touches the U.S.-Mexico border. Since the demarcation of the district in 1993, been consistently blue and Hispanic. The list of representatives include Frank Tejeda, Ciro Rodriguez and now, Henry Cuellar.</p> 
                <p>The next three most concentrated congressional districts are in Florida. They average 63% Hispanic electorates. FL27 was created in 2012, after the 2010 census, and is entirely within Miami-Dade County. Ileana Ros-Lehtinen, a Cuban-American and a Republican who previously represented the 18th district, is the current representative. </p> 
                <p>With a population that’s 71% Hispanic, FL25 spans from Miami to the Everglades in the west. Cuban-American and Republican, Mario Díaz Balart, represents this district. Balart is the son of Cuban politician, Rafael Diaz-Balart. His aunt, Mirta Diaz-Balart, was Fidel Castro’s first wife. The district, created in 2003, was previously represented by one other Hispanics, also a Republican, David Rivera. </p> 
                <p>Also created in 2012 after the 2010 census, FL26 occupies parts of Monroe and Miami-Dade counties. Joe Garcia, a Democrat of Cuban heritage, is its current representative. </p> 
                <p>Lastly the 10th most highly concentrated population of Hispanics hail from NY15, the smallest congressional district the US. NY15 is located entirely within The Bronx. It is one of the most democratic districts of the country. John Kerry won with 90% of votes in 2004 and Obama won with 96.7% in 2012. Jose E. Serrano, a Democrat and Puerto Rican, is the current representative.</p> 
			</div>		
			<div class="nota">
				<div class="titulo_nota">
				...
				<div class="parrafo">						
					<p>The data used was taken from the following sources: data related to the House of Representatives election results (2006 a 2012) was taken from the <a href="http://www.fec.gov/pubrec/electionresults.shtml" target="_blank">Federal Election Commission</a>; the predictions for the 2014 election results were taken from the Election Lab of the <a href="http://www.washingtonpost.com/wp-dre/politics/election-lab-2014?hpid=z1" target="_blank">Washington Post</a>; the predictions regarding what would happen if no Hispanics voted and if all Hispanics over 18 years of age voted in 2014 were constructed based on the predictions made by John Sides for the Washington Post and simulations were made using the program <a href="hipervínculo a:http://www.gvpt.umd.edu/uslaner/clarify.pdf" target="_blank">Clarify</a>; the data regarding representatives of hispanic origin was constructed based on the member list of the House of Representatives; coin-toss district data was obtained from the <a href="http://www.washingtonpost.com/wp-dre/politics/election-lab-2014?hpid=z1" target="_blank">Washington Post</a> predictions by John Sides, using districts assigned a winning probability between 50 and 74% ; the variable that identifies states belonging to the "Bible belt" was constructed using several sources that mention the states commonly placed under this category; the sociodemographic and demographic data was obtained from the <a href="http://factfinder2.census.gov/faces/nav/jsf/pages/index.xhtml" target="_blank">American Community Survey</a>, which includes census data already calculated by congressional district.</p>
					<p>To make predictions in the case that no Hispanics voted and in the case that all Hispanics over 18 years old voted, a series of regression analyses were used. The models used where: linear regression (OLS), logistic regression (Logit and Probit) and simulations of these models generated using <a href="http://www.gvpt.umd.edu/uslaner/clarify.pdf" target="_blank">Clarify</a></p>
					<p>For more details regarding the process of investigation used to complete this project read the following <a href="https://www.dropbox.com/s/cz504m8ounlvnf4/Metodolog%C3%ADa.pdf" target="_blnak">document</a>.</p>
				</div>			
			</div>
			<a href="https://www.dropbox.com/sh/yvlpv1rin74ssso/AABL4MCUeN8_iSaCuwIyC7iea" target="blank">
				<img src="images/btn_descarga_eng.png" class="boton">
			</a>			
		</div>
